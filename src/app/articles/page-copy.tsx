...
export default function Artikel() {
	...
	return (
		<div className="w-full flex flex-col gap-3 md:min-h-screen justify-between">
			...
			{data.map((item) => (
				<div className="flex flex-col mx-4 md:mx-10 mt-8 rounded-xl" key={item.id}>
					<div className="flex flex-col gap-4">
						...
						{item.content.map((content) => (
							<Link
								...
								className="flex justify-between ml-8 md:ml-20 mx-4 p-8 rounded-xl h-40 bg-sky-100 hover:text-white hover:bg-blue-500">
								<div className="py-4 h-full flex justify-between">
									<div className="flex flex-col gap-2 justify-between">
